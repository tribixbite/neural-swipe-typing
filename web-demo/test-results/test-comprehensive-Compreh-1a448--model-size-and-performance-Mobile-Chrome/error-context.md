...
- generic [active] [ref=e1]:
  ...
  - main [ref=e11]:
    ...
    - generic [ref=e20]:
      ...
      - generic [ref=e22]: C → V → B
    - application "Swipe keyboard - draw gestures to input text" [ref=e26]
    - generic [ref=e27]:
      - heading "Predictions" [level=2] [ref=e28]
      - generic [ref=e29]:
        - button "connections" [ref=e30] [cursor=pointer]
        - button "commens" [ref=e31] [cursor=pointer]
        - button "commensions" [ref=e32] [cursor=pointer]
        - button "comment" [ref=e33] [cursor=pointer]
        - button "continues" [ref=e34] [cursor=pointer]
    - generic [ref=e35]:
