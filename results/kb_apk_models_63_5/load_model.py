#!/usr/bin/env python3
"""Load the exported 0.635 accuracy model."""

import torch
from model import MODEL_GETTERS_DICT

def load_model(device='cpu'):
    """Load the 0.635 accuracy neural swipe typing model."""
    
    model_params = {'n_coord_feats': 6, 'n_keys': 29, 'vocab_size': 67, 'max_word_len': 30}
...
if __name__ == "__main__":
    ...
    print(f"Accuracy: 0.635")
    print(f"Vocab size: 67")
